...
class_names = ['Mask Detected', 'Not', 'cat', 'dog', 'flower', 'fruit', 'motorbike', 'person']
...
def predicter():
    ...
    return render_template('result.html', result_text=result_text, img_path="http://127.0.0.1:8887/static/images/"+file.filename)
